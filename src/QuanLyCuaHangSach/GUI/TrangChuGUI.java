...
public class TrangChuGUI extends JFrame {
    ...
    public TrangChuGUI() {
        ...
        BanHangGUI trangBanHang = new BanHangGUI();
        trangBanHang.setBounds(0, 0, panelsanpham.getWidth(), panelsanpham.getHeight());
        panelsanpham.add(trangBanHang);
