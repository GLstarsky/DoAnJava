...
import QuanLyCuaHangSachBUS.NhaXuatBanBUS;
import QuanLyCuaHangSachBUS.SachBUS;
import QuanLyCuaHangSachBUS.TheLoaiBUS;
import QuanLyCuaHangSachDAO.MySQLConnect;
import QuanLyCuaHangSachDTO.NhaXuatBan;
import QuanLyCuaHangSachDTO.Sach;
import QuanLyCuaHangSachDTO.TheLoai;
...
//		                SachBUS.updateImagePathToDatabase(maSach, imagePath);
		...
		JComboBox<String> cbBSapXep1 = new JComboBox<>();
		...
		JComboBox<String> cbBSapXep2 = new JComboBox<>();
