...
public class TrangBanHang extends JFrame {
	...
	private void thayDoiSoLuongGioHang(ArrayList<chiTietGioHang> gioHang, JSpinner spnGioHang_SoLuong,
		...
		for (chiTietGioHang element : gioHang) {
			if (element.getMaSach() == Integer.parseInt(lblGioHang_MaSach.getText())) {
				element.soLuong = (int) spnGioHang_SoLuong.getValue();
				element.tongTien = element.soLuong * element.donGia;
				lblGioHang_TongTien.setText(formatGiaTien(element.tongTien));
				break;
			}
		}
	}
...
//	                // Ẩn GUI hiện tại
//	                setVisible(false);
//	                // Hiển thị XemPhieuNhapGUI
//	                HoaDonGUI hoadon = new HoaDonGUI();
//	                JFrame frame = new JFrame();
//	                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//	                frame.setBounds(100, 100, 800, 600);
//	                frame.setContentPane(hoadon);
//	                frame.setVisible(true);
//	            }
//	        });
		...
		btnTiepTuc.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				khuyenmai.setLocationRelativeTo(TrangBanHang.this);
				if (gioHang.size() == 0) {
		...
		btnXemDanhSachHoaDon.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				HoaDonGUI xemhoadon = new HoaDonGUI();
				xemhoadon.setLocationRelativeTo(TrangBanHang.this);
