...
import QuanLyCuaHangSachBUS.CTPhieuNhapBUS;
import QuanLyCuaHangSachBUS.PhieuNhapBUS;
import QuanLyCuaHangSachBUS.Sach2BUS;
import QuanLyCuaHangSachDAO.CTPhieuNhapDAO;
import QuanLyCuaHangSachDTO.CTPhieuNhapDTO;
import QuanLyCuaHangSachDTO.NhaCungCapDTO;
...
public class QuanLiNhapHangGUI extends JPanel {
	...
	public QuanLiNhapHangGUI() {
		...
		txtMaPN.setText(TOOL_TIP_TEXT_KEY);
		panel.add(txtMaPN);
		...
		btnLuu.setIcon(new ImageIcon(
				QuanLiNhapHangGUI.class.getResource("/icon/Custom-Icon-Design-Flatastic-9-Save-as.24.png")));
		...
		btnTaoPhieu.addMouseListener(new java.awt.event.MouseAdapter() {
			...
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				try {
					...
					txtMaPhieuNhap.setText(String.valueOf(maPN)); // Chuyển số nguyên thành chuỗi trước khi đặt vào
																	// JTextField
		...
		panel_2.setBorder(new TitledBorder(null, "CHI TI\u1EBET PHI\u1EBEU NH\u1EACP", TitledBorder.CENTER,
				TitledBorder.TOP, null, new Color(252, 136, 97)));
		...
		tblCTPN.setModel(new DefaultTableModel(new Object[][] { { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null },
				{ null, null, null, null, null },

		}, new String[] { "Mã phiếu nhập", "Mã sách", "Số lượng", "Đơn giá ", "Thành tiền" }));
		...
		lblNewLabel_1_2_1.setBounds(604, 53 - 40, 138, 23);
		panel_2.add(lblNewLabel_1_2_1);

		JLabel lblNewLabel_1_2_1_1 = new JLabel("Mã sách:");
		lblNewLabel_1_2_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1_1.setBounds(604, 96 - 40, 109, 23);
		panel_2.add(lblNewLabel_1_2_1_1);

		JLabel lblNewLabel_1_2_1_5 = new JLabel("Giá đang bán:");
		lblNewLabel_1_2_1_5.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1_5.setBounds(604, 95, 109, 23);
		panel_2.add(lblNewLabel_1_2_1_5);

		JLabel lblNewLabel_1_2_1_2 = new JLabel("Giá nhập:");
		...
		txtMaPhieuNhap.setBounds(730, 50 - 40, 203, 29);
		panel_2.add(txtMaPhieuNhap);

		cbbMaSachKhiTaoCTPN = new javax.swing.JComboBox<>();
		cbbMaSachKhiTaoCTPN.setFont(new Font("Tahoma", Font.PLAIN, 14));
		cbbMaSachKhiTaoCTPN.setBounds(730, 93 - 40, 203, 29);
		panel_2.add(cbbMaSachKhiTaoCTPN);

		txtGiaDangBan = new JTextField();
		txtGiaDangBan.setFont(new Font("Tahoma", Font.PLAIN, 14));
		txtGiaDangBan.setColumns(10);
		txtGiaDangBan.setBounds(730, 92, 203, 29);
		panel_2.add(txtGiaDangBan);
		txtGiaDangBan.setEditable(false);
		...
		btnThemCTPN.setIcon(
				new ImageIcon(QuanLiNhapHangGUI.class.getResource("/icon/Custom-Icon-Design-Flatastic-1-Add.16.png")));
		...
		btnSua.setIcon(new ImageIcon(
				QuanLiNhapHangGUI.class.getResource("/icon/Custom-Icon-Design-Pretty-Office-10-Pencil.24.png")));
		...
		btnXoa.setIcon(
				new ImageIcon(QuanLiNhapHangGUI.class.getResource("/icon/Awicons-Vista-Artistic-Delete.24.png")));
		...
		panel_3.setBorder(new TitledBorder(
				...
				"Phi\u1EBFu nh\u1EADp", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(251, 125, 0)));
		...
		tblPN.setModel(new DefaultTableModel(new Object[][] { { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null },
				{ null, null, null, null, null },

		}, new String[] { "Mã ", "Mã NCC", "Mã NV", "Ngày nhập", "Tổng tiền " }));
		...
		panel_2_1.setBorder(new TitledBorder(null, "T\u00CCM KI\u1EBEM", TitledBorder.LEADING, TitledBorder.TOP, null,
				new Color(255, 102, 28)));
		...
		btnTimKiemTheoNgay.setIcon(new ImageIcon(
				QuanLiNhapHangGUI.class.getResource("/icon/Custom-Icon-Design-Flatastic-1-Search.24.png")));
		...
		panel_1_1.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"Chi ti\u1EBFt phi\u1EBFu nh\u1EADp", TitledBorder.CENTER, TitledBorder.TOP, null,
				new Color(255, 156, 108)));
		...
		txtMasach.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				bus.loadDonGia(txtDongia, txtMasach.getText());
			}
		});
		...
		txtDongia.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				int maxDonGia = Integer.parseInt(txtDongia.getText());
				try {
					int enteredValue = Integer.parseInt(txtDongia.getText());
					if (enteredValue <= 0 || enteredValue > maxDonGia) {
						JOptionPane.showMessageDialog(null, "Đơn giá phải là số nguyên dương và nhỏ hơn giá bán ra.",
								"Lỗi nhập liệu", JOptionPane.ERROR_MESSAGE);
						txtDongia.setText(maxDonGia + "");
					}
		...
		tblCTPN1.setModel(new DefaultTableModel(new Object[][] { { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null },
				{ null, null, null, null, null },
		...
		panel_3_1.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"T\u00CCM KI\u1EBEM", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(255, 145, 34)));
		...
		btnTKDonGia.setIcon(new ImageIcon(
				QuanLiNhapHangGUI.class.getResource("/icon/Custom-Icon-Design-Flatastic-1-Search.24.png")));
		...
		loadMaNV();
		loadMaSach();
		chonSachKhiTaoCTPN(cbbMaSachKhiTaoCTPN, txtGiaDangBan);
	}

	public void btnThemCTPhieu(java.awt.event.MouseEvent evt) {
		if (!checkSoNguyenDuong(txtSoLuong.getText())) {
			JOptionPane.showMessageDialog(null, "Vui lòng nhập vào số lượng lớn hơn 0");
		} else {
			if (!checkSoNguyenDuong(txtDonGia.getText())) {
				JOptionPane.showMessageDialog(null, "Vui lòng nhập số thực vào giá nhập");
			} else if (checkSoNguyenDuong(txtDonGia.getText())
					&& laySoNguyen(txtDonGia.getText()) >= laySoNguyen(txtGiaDangBan.getText())) {
				JOptionPane.showMessageDialog(null, "Yêu cầu giá nhập thấp hơn giá đang bán");
			} else {
				int donGia = Integer.parseInt(txtDonGia.getText());
				int soLuong = Integer.parseInt(txtSoLuong.getText());
				CTPhieuNhapDTO ctpn = new CTPhieuNhapDTO();
				ctpn.maPhieuNhap = Integer.parseInt(txtMaPhieuNhap.getText());
				ctpn.maSach = laySoNguyen(cbbMaSachKhiTaoCTPN.getSelectedItem().toString());
				ctpn.dongia = donGia;
...
//	        ctpn.maSach = Integer.parseInt(txtMaSach.getText());
			...
			for (int a = 0; a < model.getRowCount(); a++) {
				String tien = model.getValueAt(a, 4).toString().replaceAll(",", ""); // Loại bỏ dấu phẩy trước khi tính
																						// toán
				if (!tien.isEmpty()) {
...
//	        txtMaSach.setText("");
	...
	public void setTextMaPhieuNhap() {
		PhieuNhapBUS bus = new PhieuNhapBUS();
		int ma = bus.themMaPhieuNhap();
		txtMaPN.setText(ma + "");
	}

	public void loadMaNV() {
		PhieuNhapBUS bus = new PhieuNhapBUS();
		bus.danhsachNhanVien(txtMaNV);
	}

	public void loadMaSach() {
		PhieuNhapBUS bus = new PhieuNhapBUS();
		bus.danhsachSach(cbbMaSachKhiTaoCTPN);
	}

	public static boolean checkSoNguyenDuong(String str) {
	...
	public void loadGiaSachDangBan(int maSach, JTextField txtGiaDangBan) {
		Sach2BUS sachbus = new Sach2BUS();
		Sach2DTO sach = sachbus.getSach(maSach);
		if (sach != null) {
			int giaDangBan = sach.getDonGia();
			txtGiaDangBan.setText(formatGiaTien(giaDangBan));
		} else {
			// Xử lý trường hợp không tìm thấy sách, có thể đặt giá trị mặc định
			txtGiaDangBan.setText(""); // Hoặc một thông báo nào đó
		}
	}
...
//	public void capNhatGiaSanPhamSauKhiNhapHang(ArrayList<CTPhieuNhapDTO> dsCTPhieuNhap) {
//		for(int i=0; i<dsCTPhieuNhap.size(); i++) {
//			int maSachDaNhap =
//		}
//	}

	public class TrungBinhGiaNhapTheoMaSach {
		private int maSach;
		private int trungBinhGiaNhap;

		public TrungBinhGiaNhapTheoMaSach(int maSach, int trungBinhGiaNhap) {
	        this.maSach = maSach;
	        this.trungBinhGiaNhap = trungBinhGiaNhap;
	    }
	    ...
	    public int getTrungBinhGiaNhap() {
	        return trungBinhGiaNhap;
	    }
	}


	public void luuPhieu(java.awt.event.ActionEvent evt) {
		if (txtMaPN.getText().trim().isEmpty() || txtMaNCC.getText().trim().isEmpty()
				|| txtMaNV.getSelectedItem() == null || dateNgayNhap == null) {
		...
		try {
			...
			pn.maNV = laySoNguyen(txtMaNV.getSelectedItem().toString());
			...
			Sach2BUS sachbus = new Sach2BUS();
			ArrayList<Sach2DTO> listSach =  sachbus.getListSach();
			for (int i = 0; i < model.getRowCount(); i++) {
				CTPhieuNhapDTO ctpn = new CTPhieuNhapDTO();
...
//========================= Update giá ==============================================
				for (Sach2DTO element : listSach) {
					if(element.getMaSach()==Integer.parseInt(model.getValueAt(i, 1).toString())) {
						int maSach = Integer.parseInt(model.getValueAt(i, 1).toString());
						int giaNhap = Integer.parseInt(model.getValueAt(i, 2).toString());
						sachbus.updateGiaBanMoi(maSach, giaNhap);
					}
				}
			}
//=======================================================================
			...
			txtMaPN.setText("");
			txtMaNCC.setText("");
			txtMaNV.setSelectedItem("");

			dateNgayNhap.setDate(null);
			txtTongTien.setText("");
			txtMaPhieuNhap.setText("");
			cbbMaSachKhiTaoCTPN.setSelectedIndex(0);
			txtDonGia.setText("");
			txtSoLuong.setText("");
			txtThanhTien.setText(getName());

			JOptionPane.showMessageDialog(null, "Lưu phiếu nhập thành công!", "Thông báo",
					JOptionPane.INFORMATION_MESSAGE);
		} catch (Exception e) {
			// Hiển thị thông báo lưu thất bại và in ra lỗi để debug
			JOptionPane.showMessageDialog(null, "Lưu phiếu nhập thất bại: " + e.getMessage(), "Lỗi",
		...
		if (selectedRow != -1) {
			...
			try {
				...
				for (CTPhieuNhapDTO chiTiet : chiTietList) {
					...
					chiTietModel.addRow(new Object[] { chiTiet.getMaPhieuNhap(), chiTiet.getMaSach(),
							chiTiet.getDongia(), chiTiet.getSoluong(), (Thanhtien) });
				}
	...
	public void chonSachKhiTaoCTPN(JComboBox<String> cbbMaSachKhiTaoCTPN, JTextField txtGiaDangBan) {
		cbbMaSachKhiTaoCTPN.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Object selectedItem = cbbMaSachKhiTaoCTPN.getSelectedItem();
				if (selectedItem != null) {
					int maSach = laySoNguyen(selectedItem.toString());
					loadGiaSachDangBan(maSach, txtGiaDangBan);
				}
			}
		});
	}
	...
	private javax.swing.JComboBox<String> cbbMaSachKhiTaoCTPN;
	...
	private JTextField txtTongtien;
	private JTextField txtGiaDangBan;
